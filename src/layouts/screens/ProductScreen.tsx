...
import { View, Text, Image, FlatList, StyleSheet, Dimensions,Pressable, ScrollView, TouchableOpacity} from 'react-native';
            ...
            <View style={styles.modalContent} >
              ...
              <View>
                <RadioButton.Group onValueChange={handleRadioButtonChange} value={checked} >
                  <RadioButton.Item label="Popularity" value="popularity" color={Colors.brand_primary} labelStyle={{}} />
                  <RadioButton.Item label="Price- Low to High" value="price_low_to_high" color={Colors.brand_primary} labelStyle={{}} />
                  <RadioButton.Item label="Price- High to Low" value="price_high_to_low" color={Colors.brand_primary} labelStyle={{}} />
                  <RadioButton.Item label="Newest First" value="newest" color={Colors.brand_primary} labelStyle={{}} />
                </RadioButton.Group>
              </View>
            </View>
          </Modal>
